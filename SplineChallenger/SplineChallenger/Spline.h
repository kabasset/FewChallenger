...
/**
 * @brief Flexibility-oriented cubic spline.
 * 
 ...
 * Focs separates the spline classes in components (intervals, knots and arguments), which each hold their cache.
 ...
 * This allow recomputing only what has changed.
 * 
